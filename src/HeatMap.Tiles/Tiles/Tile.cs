...
namespace HeatMap.Tiles.Tiles
{
    ...
    internal class Tile
    {
        ...
        /// <summary>
        /// Gets the parent at the given zoom.
        /// </summary>
        /// <param name="zoom">The zoom level.</param>
        /// <returns>The parent tile.</returns>
        public Tile ParentAt(int zoom)
        {
            var factor = 1 << (this.Zoom - zoom);
            return new Tile(this.X  / factor, this.Y /factor, zoom);
        }
        ...
        public int GetSubTileFactor(int zoom)
        {
            return 1 << (zoom - this.Zoom);
        }
